    ...
    <div class=" bg-half_dark rounded-2xl">
        ...
        <div class="p-4">
            <div class="players grid grid-cols-3 grid-rows-4">
                ...
                <span  class="w-full relative rounded-2xl bg-dark text-white text-4xl font-bold aspect-square flex justify-center items-center row-start-2 col-start-3" :class="showMiles || (battle.pick != 0 && battle.userResult < battle.opponentResult) ? 'user-picked' : ''">
